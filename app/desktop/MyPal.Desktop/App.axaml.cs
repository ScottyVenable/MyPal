...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            var backendDir = Path.Combine(rootAppDir, "backend");
            ...
            mainWindow.Opened += async (_, _) => await mainWindowViewModel.InitializeAsync();
    ...
    private static string ResolveAppDirectory()
    {
        ...
        {
            throw new DirectoryNotFoundException($"Unable to locate application directory from base path: {baseDir}");
        }
